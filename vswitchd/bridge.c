...
/* Internal representation of conntrak zone configuration table from OVSDB. */
struct ct_zone {
    uint16_t zone;
...
/* Internal representation of datapath configuration table from OVSDB. */
struct datapath {
    char *type;                 /* Datapath type. */
