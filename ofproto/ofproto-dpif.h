...
struct dpif_backer {
    ...
    /* Connection tracking */
    unsigned int last_idl_change;
    struct id_pool  *timeout_policy_ids;    /* Datapath timeout policy
                                             * allocation. */
    struct cmap ct_zones;                   /* "struct ct_zone"s indexed by
                                             * zone id. */
    struct cmap ct_tps;                     /* "struct ct_timeout_policy"s
                                             * indexed by uuid. */
    struct ovs_list ct_tp_kill_list;        /* a list of timeout policy to be deleted. */
